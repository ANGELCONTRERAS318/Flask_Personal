function showDetails(section) {
    ...
    if (section === 'about') {
        ...
        images.innerHTML = `<h3>Imágenes</h3><img src="https://via.placeholder.com/150" alt="Experiencia">`;
        ...
        images.innerHTML = `<h3>Imágenes</h3><img src="https://via.placeholder.com/150" alt="Educación">`;
    }
}
